        ...
        <section class="section">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="{{ route('admin.position.create') }}" class="btn btn-primary">Create</a>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            <tr>
                            ...
                            @foreach($positions as $position)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center align-items-center">
                                        ...
                                        <a class="btn btn-success" href="{{route("admin.position.show", $position->id)}}">Show</a>
                                        <a class="btn btn-primary" href="{{route("admin.position.edit", $position->id)}}">Edit</a>
                                    </td>
                                </tr>
