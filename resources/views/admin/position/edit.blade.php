...
<div class="container mt-5" style="max-width: 720px;">
    <div class="card shadow-lg" style="border-radius: 15px;">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center" style="border-top-left-radius: 15px; border-top-right-radius: 15px;">
            <h5 class="mb-0">✏️ Lavozimni tahrirlash</h5>
            <a href="{{ route('admin.position.index') }}" class="btn btn-light btn-sm">Orqaga</a>
        </div>
            ...
            <form action="{{ route('admin.position.update', $position->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('name_uz', $position->name_uz) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('name_ru', $position->name_ru) }}"
                ...
                <div class="d-flex justify-content-center gap-3 mt-4">
                    <button type="submit" class="btn btn-success btn-lg px-5">🔄 Yangilash</button>
                    <a href="{{ route('admin.position.index') }}" class="btn btn-secondary btn-lg px-5">Orqaga</a>
                </div>
            </form>
        </div>
    </div>
