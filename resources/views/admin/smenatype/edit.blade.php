            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="name_uz" placeholder="name..." name="name_uz" value="{{ $smenatype->name_uz }}">
                    </div>

                    <div class="mb-4">
                        <label for="name_ru" class="form-label">Name (ru)</label>
                        <input type="text" class="form-control" id="name_ru" placeholder="name..." name="name_ru" value="{{ $smenatype->name_ru }}">
                    </div>
