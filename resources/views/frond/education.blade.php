                                        ...
                                        <a href="{{ route('educationDetail', $schudel->id) }}">
                                            <div>
                                                <div class="icon">
                                                    ...
                                                    <img alt="icon" src="{{ asset('/image/darsjadval.JPG') }}" class="img-fluid" width="80" height="80">
                                                </div>

                                                {{-- to'g'ri o'zgaruvchi nomi: $schudel --}}
                                                <h1>{{ $schudel->classModel?->{ 'name_'. \App::getLocale() } }}</h1>
